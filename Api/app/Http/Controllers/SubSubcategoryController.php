...
class SubSubcategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        return DB::table('sub_sub_categories')->join('categories', 'categories.id', '=', 'sub_sub_categories.category_id')
            ...
            ->select('categories.name as category', 'sub_categories.name as subcategory', 'sub_sub_categories.*')->orderByRaw('ISNULL(sub_sub_categories.serial), sub_sub_categories.serial ASC')->get();
    }
