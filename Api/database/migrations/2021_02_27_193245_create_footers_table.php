...
class CreateFootersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('footers', function (Blueprint $table) {
            ...
            $table->string('description')->default('Lorem ipsum dolor sit amet, consecrated advising elite, sed do emus tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida.')->nullable();
            $table->string('copyright', 100)->default('© 2020 Bongo Bazar All Rights reserved');
