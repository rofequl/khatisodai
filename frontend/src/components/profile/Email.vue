<template>
  <a-modal centered :width="350" :visible="modelOpen" :footer="null"
           @cancel="$emit('closeModel')" :title="isUpdate? 'Change email address':'Connect with email ID'">
